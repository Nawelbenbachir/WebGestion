                    ...
                    @auth
                        <div class="flex space-x-4">
                            ...
                            <x-nav-link :href="route('clients.index')" :active="request()->routeIs('clients.index')">
                                <div class="flex items-center space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-violet-500 dark:text-violet-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <x-nav-link :href="route('avoirs.index')" :active="request()->routeIs('avoirs.*')">
                                <div class="flex items-center space-x-2">
                            ...
                            <x-nav-link :href="route('reglements.index')" :active="request()->routeIs('reglements.index')">
                                <div class="flex items-center space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5  text-teal-500 dark:text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                <x-responsive-nav-link :href="route('avoirs.index')" :active="request()->routeIs('avoirs.*')">
                    <div class="flex items-center space-x-2">
