...
<form action="{{ route('societes.store') }}" method="POST" class="text-sm">
    @csrf
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-4 bg-gray-50 dark:bg-gray-900 p-3 rounded-t-lg border-b dark:border-gray-700">
        ...
        <div class="md:col-span-5 space-y-3 border-r dark:border-gray-700 pr-4">
            ...
            <div class="grid grid-cols-3 gap-2">
                <div class="col-span-1">
                    ...
                    <input type="text" name="code_societe" value="{{ old('code_societe') }}"
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" name="nom_societe" value="{{ old('nom_societe') }}"
        ...
        <div class="md:col-span-7 space-y-3">
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="adresse1" value="{{ old('adresse1') }}" placeholder="Rue..."
                       class="w-full rounded border-gray-300 dark:bg-gray-800 dark:text-white px-2 py-1">
                <input type="text" name="adresse2" value="{{ old('adresse2') }}" placeholder="Appartement, étage..."
                       class="w-full rounded border-gray-300 dark:bg-gray-800 dark:text-white px-2 py-1">
                <input type="text" name="complement_adresse" value="{{ old('complement_adresse') }}" placeholder="Complément (ZA, etc.)"
                       class="w-full rounded border-gray-300 dark:bg-gray-800 dark:text-white px-2 py-1">
            </div>
            ...
            <div class="grid grid-cols-12 gap-2 p-2 bg-blue-50/50 dark:bg-blue-900/10 rounded-lg border border-blue-100 dark:border-blue-900/30">
                <div class="col-span-8">
                    ...
                    <input type="text" name="iban" value="{{ old('iban') }}" maxlength="34" placeholder="FR76..."
                ...
                <div class="col-span-4">
                    ...
                    <input type="text" name="swift" value="{{ old('swift') }}" maxlength="11" placeholder="BNPAFRPP"
                           class="w-full rounded border-gray-300 dark:bg-gray-800 dark:text-white px-2 py-1 font-mono text-xs uppercase">
                </div>
            </div>
        </div>
    ...
    <div class="flex justify-end items-center gap-3 p-4 border-t bg-gray-50 dark:bg-gray-900 rounded-b-lg">
        ...
        <x-primary-button class="px-6 py-2 shadow-md bg-indigo-600 hover:bg-indigo-700">
            Enregistrer
        </x-primary-button>
    </div>
</form>