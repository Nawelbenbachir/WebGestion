...
<form id="facture-edit-form" action="{{ route('documents.update', $document->id) }}" method="POST" class="text-sm">
    @csrf
    @method('PUT')
    ...
    <input type="hidden" id="type_document" name="type_document" value="{{ $type ?? 'facture' }}">
