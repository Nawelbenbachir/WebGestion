...
<x-layouts.table createRoute="documents.create" createLabel="Nouveau Devis">
        ...
        <table class="min-w-full border-separate border-spacing-0">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                @foreach($documents as $document)
                    ...
                    @endphp
                    {{-- On utilise data-id et data-route pour que le double-clic du script table fonctionne --}}
