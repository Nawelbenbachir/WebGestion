        ...
        <table id="documents-table" class="min-w-full border border-gray-200">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-6 py-3 border-b border-r border-gray-300 text-center">Code Facture</th>
            ...
            <tbody>
                @foreach($facture as $document)
                    <tr data-id="{{ $document->id }}" data-route="documents" class="cursor-pointer hover:bg-blue-100">
